...
# installed.
TCL_PREFIX='/Users/pamel/Documents/idk/ml_ds_course/heart-disease-project/env'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/Users/pamel/Documents/idk/ml_ds_course/heart-disease-project/env'
...
TCL_EXTRA_CFLAGS='-march=core2 -mtune=haswell -mssse3 -ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -I/Users/pamel/Documents/idk/ml_ds_course/heart-disease-project/env/include -fdebug-prefix-map=${SRC_DIR}=/usr/local/src/conda/${PKG_NAME}-${PKG_VERSION} -fdebug-prefix-map=${PREFIX}=/usr/local/src/conda-prefix -pipe  -arch x86_64 -D_FORTIFY_SOURCE=2 -mmacosx-version-min=10.9 '
...
TCL_LD_FLAGS='-Wl,-pie -Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/Users/pamel/Documents/idk/ml_ds_course/heart-disease-project/env/lib -L/Users/pamel/Documents/idk/ml_ds_course/heart-disease-project/env/lib -headerpad_max_install_names -Wl,-search_paths_first '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/Users/pamel/Documents/idk/ml_ds_course/heart-disease-project/env/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/Users/pamel/Documents/idk/ml_ds_course/heart-disease-project/env/include'
...
TCL_PACKAGE_PATH='/Users/pamel/Documents/idk/ml_ds_course/heart-disease-project/env/lib '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/Users/pamel/Documents/idk/ml_ds_course/heart-disease-project/env/lib -ltclstub8.6'
...
TCL_STUB_LIB_PATH='/Users/pamel/Documents/idk/ml_ds_course/heart-disease-project/env/lib/libtclstub8.6.a'
